...
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e " ${WH}SSHWS ${WH}[${COLOR1}${ssh1}${WH}]  ${WH}VLESS ${WH}[${COLOR1}${vmc}${WH}]  ${WH}VMESS ${WH}[${COLOR1}$ssx${WH}]
echo -e   ${WH}TROJAN ${WH}[${COLOR1}${vlx}${WH}]  ${WH}SSWS ${WH}[${COLOR1}${trx}${WH}]  ${WH}[${COLOR1}ᴍᴇɴᴜ${WH}]
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
